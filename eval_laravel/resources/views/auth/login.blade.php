    ...
    <div class="w-full max-w-md">
            ...
            <div class="p-8">
                ...
                <form action="{{ route('login') }}" method="post" id="loginForm">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="relative">
                            ...
                            <input 
                                ...
                                id="username"
                                name="username"
                                class="w-full pl-10 pr-3 py-3 border-2 rounded-lg focus:outline-none focus:border-indigo-500 transition duration-300 @error('username') border-red-500 @enderror"
                    ...
                    <div class="mb-6">
                        ...
                        <div class="relative">
                            ...
                            <input 
                                ...
                                id="password"
                                name="password"
                                class="w-full pl-10 pr-10 py-3 border-2 rounded-lg focus:outline-none focus:border-indigo-500 transition duration-300 @error('password') border-red-500 @enderror"
                    ...
                    <button
                        type="submit"
                        id="submitButton"
                        class="w-full bg-gradient-to-r from-indigo-600 to-purple-600 text-white py-3 rounded-lg hover:from-indigo-700 hover:to-purple-700 transition duration-300 ease-in-out transform hover:scale-105 flex items-center justify-center"
                    >
        ...
        <div class="text-center mt-6">
            <p class="text-white">
                ...
                <a href="#" class="font-semibold text-white hover:text-indigo-200 transition duration-300">
                    Create an account
                </a>
            </p>
        </div>
